...
class LogViewerDialog(ctk.CTkToplevel):
    ...
    def schedule_refresh(self):
        ...
        if self.auto_refresh:
            self.refresh_logs()
            self.refresh_job = self.after(5000, self.schedule_refresh)  # Refresh every 5 seconds
